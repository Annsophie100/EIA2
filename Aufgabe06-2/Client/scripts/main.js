...
(function (eisdealer_server) {
    ...
    function init() {
        ...
        for (let produktArt in eisdealer_server.produktListeGesamt) {
            //variable für "inneres array" => array of Produkt
            let produktListeEinzeln = eisdealer_server.produktListeGesamt[produktArt];
...
})(eisdealer_server || (eisdealer_server = {})); //namespace
