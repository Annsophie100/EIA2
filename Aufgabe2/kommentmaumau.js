...
(function (Aufgabe02) {
    ...
    let kartenstapel;
    let startKarte;
    let main = document.getElementById("main"); //eine Variable vom Typ HTML Element. Erzeugt Main. Sucht im HTML Main und greift auf id Main zu.
    function init() {
    ...
    function createSection(_name) {
        ...
        let section = document.createElement("section"); // es wird eine Section erstellt
        ...
        switch (_name) {
            ...
            case "hand": // 5 Karten auf der Hand müssen gemacht werden. weil die ja genauer angezeigt werden müssen
                ...
                for (let i = 0; i < handkarten.length; i++) { // ich mach ne variable die ist ne number und die ist null. i muss zb kleiner als 5 sein. wenn nicht ist for zu ende.
    ...
    function createCard(_src, _parent) {
        ...
        let card = document.createElement("img"); // Images werden erstellt. Im dokument der passende Tag
...
//# sourceMappingURL=kommentmaumau.js.map